            ...
            <div className={this.props.className}>
                <div className='owl'>
                    <div className='hand-left hand'
                         style={(focusItem === 1 || focusItem === 2) ? styles.focusHandLeft : {}}/>
                    <div className='hand-right hand'
                         style={(focusItem === 1 || focusItem === 2) ? styles.focusHandRight : {}}/>
                    <div className='arms-box'>
                        <div className='arms arms-left'
                             style={(focusItem === 1 || focusItem === 2) ? styles.focusArmsLeft : {}}/>
                        <div className='arms arms-right'
                             style={(focusItem === 1 || focusItem === 2) ? styles.focusArmsRight : {}}/>
                    </div>
                </div>
        ...
        return (
            <div className='login-page' id='login-page'>
                ...
                <div className='container'>
                    ...
                    <RegisterForm
                        className={showBox === 'register' ? 'login-box-active login-box' : 'login-box-leave login-box'}
                        setShowBox={this.toggleShowBox}/>
                </div>
            </div>
        )
