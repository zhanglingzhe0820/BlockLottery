package surevil.culterit.springcontroller.account;

import io.swagger.annotations.*;
import surevil.culterit.blservice.account.UserBlService;
import surevil.culterit.exception.*;
import surevil.culterit.parameters.user.AvatarSaveParameters;
import surevil.culterit.parameters.user.PhoneNumberGetParameters;
...
import surevil.culterit.response.user.UserLoginResponse;
import surevil.culterit.response.user.UserRoleResponse;
import surevil.culterit.util.UserInfoUtil;
...
public class UserController {
    ...
    public ResponseEntity<Response> login(
        ...
        try {
            UserLoginResponse userLoginResponse = userBlService.login(username, password, role);
